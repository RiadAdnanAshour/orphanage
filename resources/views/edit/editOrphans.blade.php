...
<head>
    <meta charset="UTF-8">
    <title>تعديل بيانات اليتيم</title>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="id" value="{{ $orphan->id }}" class="form-control" required placeholder="الهوية">
                </div>

                <div class="form-group">
                    <strong>:الاسم الشخصي</strong>
                    <input type="text" name="personanName" value="{{ $orphan->personanName }}" class="form-control" required placeholder="الاسم الشخصي">
                </div>

                <div class="form-group">
                    <strong>:اسم الأب</strong>
                    <input type="text" name="dad" value="{{$orphan->dad}}" class="form-control" required placeholder="اسم الأب">
                </div>

                <div class="form-group">
                    <strong>:اسم الجد</strong>
                    <input type="text" name="grandfather"value="{{$orphan->grandfather}}" required class="form-control" placeholder="اسم الجد">
                </div>

                <div class="form-group">
                    <strong>:اسم العائلة</strong>
                    <input type="text" name="family" value="{{$orphan->family}}" required class="form-control" placeholder="اسم العائلة">
                </div>

                <div class="form-group">
                    <strong>:اسم الأم</strong>
                    <input type="text" name="mother"{{$orphan->mother}} required class="form-control" placeholder="اسم الأم">
                </div>
